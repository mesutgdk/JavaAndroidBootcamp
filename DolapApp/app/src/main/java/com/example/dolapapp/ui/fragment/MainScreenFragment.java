...
public class MainScreenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.productsRV.setLayoutManager(new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL));
        ...
        Products p5 = new Products(5,"Ycoo Robot Köpek","kopek","34 cm","Bebek&Çocuk Kumanda & Akülü Araçlar","Kızımın ilgisini hiç çekmedi, eşim adeta kendisi için aldı, ikisi de oynamadı :)","Az kullanılmış","Diğer","Gri",58,650);
