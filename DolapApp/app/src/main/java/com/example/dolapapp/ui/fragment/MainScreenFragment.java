...
public class MainScreenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Products p5 = new Products(5,"Ycoo Robot Köpek","kopek"," ","Bebek&Çocuk Kumanda & Akülü araçlar","Kızımın ilgisini hiç çekmedi, eşim adeta kendisi için alıd, ikisi de oynamadı :)","Az kullanılmış","Diğer","Gri",58,650);
