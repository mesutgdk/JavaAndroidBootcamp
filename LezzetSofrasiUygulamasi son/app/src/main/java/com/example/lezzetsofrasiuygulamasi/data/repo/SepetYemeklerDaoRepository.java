package com.example.lezzetsofrasiuygulamasi.data.repo;

import android.util.Log;

import androidx.lifecycle.MutableLiveData;

import com.example.lezzetsofrasiuygulamasi.data.entity.CRUDCevap;

import com.example.lezzetsofrasiuygulamasi.data.entity.SepetYemekCevap;
...
public class SepetYemeklerDaoRepository {
    public MutableLiveData<List<SepetYemekler>> sepetYemeklerListe = new MutableLiveData<>();
    ...
    public void sepetGetir(String kullanici_adi) {
        sYdao.sepetYemekleriGetir("gGeCo").enqueue(new Callback<SepetYemekCevap>()  {
            @Override
